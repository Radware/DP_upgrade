""" the script:
1. automatically save device configuration on local pc and comparing with new config after upgrade
...
def APSolute_Login(ip, u, p):
    try:
        ...
        print(a)
        with open('c:\dp_versions\log_APSolute_login.txt', 'w') as f:
            f.write(a)
...
def FTP_SERVER(filename):
    ...
    try:
        ...
        try:
            ...
            print(a)
            with open('c:\dp_versions\log_FTP_Function.txt', 'w') as f:
                f.write(a)
...
def Final():
    ...
    while True:
        ...
        if "fail" not in RES:
            try:
                ...
                print(a)
                with open('c:\dp_versions\log_GET_CONFIG.txt', 'w') as f:
                    f.write(a)
        if "fail" in RES:
    ...
    while VER_OUT != WANT_VER:
        ...
        try:
            ...
            print(PASSWORD_GEN)
            with open('c:\dp_versions\log_PASSWORD.txt', 'w') as f:
...
try:
    ...
    with open('c:\dp_versions\log_Excel_file.txt','w') as f:
        f.write(str(error),)
except IndexError as error:
    msg = str(error) + "\n" + "please fulfill the cells in the file"
    with open('c:\dp_versions\log_Excel_file.txt','w') as f:
        ...
        try:
            ...
            if VERSION >= "8.17.0":
                if WANT_VER >= "8.20.0" and WANT_VER < "8.21" or WANT_VER == "8.20":
                    url = "https://" + IP_VISION + "/mgmt/device/byip/" + DP_IP + "/config/updatesoftware?softwareVersion=v8-20&&genpassauto=true&pass=" + PASSWORD
                    print(url)
                    headers = {
                        'Cookie': Cookie,
                    ...
                    try:
                        files = [
                            ('files', open(r'C:\dp_versions\DefensePro_200-400_v8-20-2-0-b3.tgz', 'rb'))
                        ]

                    # if file not found on PC use the File name and search it on the FTP function server.
                    except:
                        filename = "DefensePro_200-400_v8-20-2-0-b3.tgz"
                    ...
                    try:
                        files = [
                            ('files', open(r'C:\dp_versions\DefensePro_200-400_v8-23-0-0-b97.tgz', 'rb'))
                        ]

                    except:
                        filename = "DefensePro_200-400_v8-23-0-0-b97.tgz.tgz"
                        files = FTP_SERVER(filename)
                        print(files)
                    headers = {
                        'Cookie': Cookie,
        ...
        try:
            ...
            if VERSION >= "8.17.0":
                if WANT_VER >= "8.20.0" and WANT_VER < "8.21" or WANT_VER == "8.20":
                    ...
                    try:
                        files = [
                            ('files', open(r'C:\dp_versions\DefensePro_20-60_v8-20-2-0-b3.tgz', 'rb'))
                        ]

                    except:
                        filename = "DefensePro_20-60_v8-20-2-0-b3.tgz"
                        files = FTP_SERVER(filename)
                        print(files)
                ...
                if WANT_VER >= "8.21.0" and WANT_VER < "8.22.0" and not WANT_VER == "8.22":
                    ...
                    try:
                        files = [
                            ('files', open(r'C:\dp_versions\DefensePro_20-60_v8-23-0-0-b97.tgz', 'rb'))
                        ]

                    except:
                        filename = "DefensePro_20-60_v8-23-0-0-b97.tgz"
                        files = FTP_SERVER(filename)
                        print(files)
        ...
        try:
            ...
            if VERSION >= "8.17.0":
                if WANT_VER >= "8.20.0" and WANT_VER < "8.21" or WANT_VER == "8.20":
                    ...
                    try:
                        files = [
                            ('files', open(r'C:\dp_versions\DefensePro_6_v8-20-2-0-b3.tgz', 'rb'))
                        ]

                    except:
                        filename = "DefensePro_6_v8-20-2-0-b3.tgz"
                        files = FTP_SERVER(filename)
                        print(files)
                    ...
                    try:
                        files = [
                            ('files', open(r'C:\dp_versions\DefensePro_6_v8-23-0-0-b97.tgz', 'rb'))
                        ]

                    except:
                        filename = "DefensePro_6_v8-23-0-0-b97.tgz"
                        files = FTP_SERVER(filename)
                        print(files)
            ...
            try:
                ...
                if VERSION >= "8.17.0":
                    if WANT_VER >= "8.21.0" and WANT_VER < "8.22.0":
                        ...
                        try:
                            files = [
                                ('files', open(r'C:\dp_versions\DefensePro_VA_v8-23-0-0-b97_Upgrade_VMware.tgz', 'rb'))
                            ]

                        except:
                            filename = "DefensePro_VA_v8-23-0-0-b97_Upgrade_VMware.tgz"
                            files = FTP_SERVER(filename)
                            print(files)
            ...
            try:
                ...
                if VERSION >= "8.17.0":
                    if WANT_VER >= "8.21.0" and WANT_VER < "8.22.0":
                        ...
                        try:
                            files = [
                                ('files', open(r'C:\dp_versions\DefensePro_VA_8-22-0-1-b107_Upgrade_KVM.tgz', 'rb'))
                            ]

                        except:
                            filename = "DefensePro_VA_8-22-0-1-b107_Upgrade_KVM.tgz"
                            files = FTP_SERVER(filename)
                            print(files)
